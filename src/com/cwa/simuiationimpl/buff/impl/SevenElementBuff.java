 ...
 *
 */
public class SevenElementBuff implements ISBuff {

	@Override
	public int getType() {
		return BuffTypeEnum.Buff_SevenElement.value();
	}
	...
	public void enter(IBuffContext context) {
		...
		for(int i=0;i<list.size();i++){
			...
			performer.getAttrMgr().setElementAttackValue(AttrSourceTypeEnum.AS_Buff.value(),list.get(i), changeValue);
		}
	}
