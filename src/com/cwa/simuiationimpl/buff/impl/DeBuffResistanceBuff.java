 ...
 *
 */
public class DeBuffResistanceBuff implements ISBuff {

	@Override
	public int getType() {
		return BuffTypeEnum.Buff_DeBuffResistance.value();
	}
	...
	public void enter(IBuffContext context) {
		...
		for(int i=0;i<list.size();i++){
			...
			performer.getAttrMgr().setDebuffResistanceValue(AttrSourceTypeEnum.AS_Buff.value(),list.get(i), changeValue);
		}
	}
