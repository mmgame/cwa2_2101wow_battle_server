 ...
 *
 */
public class SuckBlueBuff implements ISBuff {

	@Override
	public int getType() {
		return BuffTypeEnum.Buff_SuckBlue.value();
	}
	...
	public void enter(IBuffContext context) {
		...
		//修改伤害倍率
		performer.getAttrMgr().setAttrValue(AttrSourceTypeEnum.AS_Buff.value(), AttrTypeEnum.Attr_SuckBlue.value(), value);
		performer.getAttrMgr().changeConsumeValue(AttrTypeEnum.Attr_SuckBlue.value(), value);
	}
